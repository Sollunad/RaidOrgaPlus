<template>
	<div>
		...
		<p>{{ this.data.lastname + ", " + this.data.firstname }}</p>
		...
		<h2>Cookies</h2>
		<p>
			Wie viele andere Webseiten verwenden wir auch so genannte „Cookies“. Bei Cookies handelt es sich um kleine
		...
		<ul>
			...
			<li>
				Google Chrome:
				<a href="https://support.google.com/accounts/answer/61416?hl=de" target="_blank" rel="nofollow noopener"
					>https://support.google.com/accounts/answer/61416?hl=de</a
				>
			</li>
			<li>
				Opera:
				<a href="http://www.opera.com/de/help" target="_blank" rel="nofollow noopener"
		...
		<p>
			Soweit Sie uns durch Ihre Browsereinstellungen oder Zustimmung die Verwendung von Cookies erlauben, können
			folgende Cookies auf unseren Webseiten zum Einsatz kommen:
		</p>
		<p>Ein Session Cookie, mit dem man weiterhin eingeloggt bleibt auch beim verlassen der Seite. Dieser wird automatisch gelöscht wenn man sich von der Seite abmeldet. Die Dauer des Cookies beträgt 10 Jahre.</p> -->
		...
		<p>
			Es wird ein Session Cookie für die Sitzung verwendet, die mit der Anmeldung beginnt und der Abmeldung endet.
			Dieser wird für eine reibungslose Nutzung der Seite benötigt.
		</p>
		<h3>Rechtsgrundlage und berechtigtes Interesse:</h3>
		<p>
		...
		<p>
			...
			<a href="https://developers.google.com/fonts/faq" rel="noopener nofollow" target="_blank"
		...
		<p>
			...
			Die Datenschutzerklärung wurde zuletzt am 06.02.2022 aktualisiert.
		</p>
		<p />
		<p>
			<em
