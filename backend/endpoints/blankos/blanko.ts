...
export async function getElementsByEncounter(raid, enc) {
...
export async function getAllElements(raid) {
...
export async function setClass(raid, enc, position, clss) {
...
export async function setRole(raid, enc, position, role) {
...
export async function copyFromTo(raid, from, to) {
