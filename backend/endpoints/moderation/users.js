...
const stmt = 'SELECT Spieler.id, Spieler.accname, Spieler.name, Spieler.lastActive, Spieler.comment, Spieler.discord, MAX(Termin.date) AS lastTermin FROM Spieler ' +
    ...
    'UNION ' +
    'SELECT Spieler.id, Spieler.accname, Spieler.name, Spieler.lastActive, Spieler.comment, Spieler.discord, NULL FROM Spieler ' +
    'WHERE Spieler.id > 9 ' +
