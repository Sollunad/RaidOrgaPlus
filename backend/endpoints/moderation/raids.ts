...
export async function listPlayers(raidId) {
...
export async function createRaid(name) {
...
export async function addPlayer(raidId, spielerId) {
...
export async function setPlayerRole(raidId, spielerId, role) {
...
export async function removePlayer(raidId, spielerId) {
