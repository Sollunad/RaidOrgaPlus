...
const stmt = 'SELECT Spieler.id, Spieler.accname, Spieler.name, Spieler.lastActive, Spieler.comment, Spieler.discord, Spieler.role, MIN(Termin.date) AS firstTermin, MAX(Termin.date) AS lastTermin FROM Spieler ' +
	...
	'UNION ' +
	'SELECT Spieler.id, Spieler.accname, Spieler.name, Spieler.lastActive, Spieler.comment, Spieler.discord, Spieler.role, NULL, NULL FROM Spieler ' +
	'WHERE Spieler.id > 9 ' +
